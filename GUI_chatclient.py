...
class ChatClient:
    ...
    def send_chat(self):
        ...
        self.chat_transcript_area.inser('end', message.decode("utf-8")+"\n")
        self.chat_transcript_area.area.yview(END)
    ...
    def initialize_gui(self):
        ...
        self.send_btn = Label(fr[3], text='전송', command=self.send_chat)
        ...
        self.enter+enter_text_widget.pack(side=LEFT, padx=2, pady=2)
